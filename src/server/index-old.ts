...
export function startServer(dm?: DataManager) {
  ...
  // Serve React build files from dist/renderer if they exist
  ...
  server.listen(PORT, () => {
    ...
    console.log(`  - Recent Picks: http://localhost:${PORT}/overlay/recent-picks`);
    console.log(`  - All Teams: http://localhost:${PORT}/overlay/all-teams`);
